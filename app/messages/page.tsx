...
import MessagesComponent from './MessagesComponent' // Move your current messages content here
...
import { useToast } from '../contexts/ToastContext'  // instead of '../hooks/use-toast'
...
export default function Messages() {
  ...
  // Add this near the top of messages/page.tsx
  useEffect(() => {
    if (socket) {
